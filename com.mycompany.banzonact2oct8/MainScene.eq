...
public class MainScene : SEScene
{
    ...
    public void initialize(SEResourceCache rsc) {
        ...
        rsc.prepare_image("d","dog",0.5*get_scene_width(), 0.5*get_scene_height());
        image1 = add_sprite_for_image(SEImage.for_resource("d"));
        image1.move(0,0);
       
        rsc.prepare_image("b","baby",get_scene_width()*0.5, get_scene_height()*0.5);
        image2 = add_sprite_for_image(SEImage.for_resource("b"));
        image2.move(get_scene_width()*0.5,0);
       
        rsc.prepare_image("h","happyf",get_scene_width()*0.5, get_scene_height()*0.5);
        image3 = add_sprite_for_image(SEImage.for_resource("h"));
        image3.move(0, get_scene_height()*0.5);
       
        rsc.prepare_image("f","flower",get_scene_width()*0.5, get_scene_height()*0.5);
